<html>
	<head>
		...
		<style>
			body{
		background-image:url("img/donation.jpeg");
		...
		<div class="main_menu">
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						<a class="navbar-brand logo_h" href="index.html" style="color:rgb(33, 228, 15);font-size:20px;font-weight:bold;">GREEN SOCIETY</a>
	...
	<br>
		...
		<div class="sign-up-form">
			...
			<h1> </h1>
				...
				<form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_GytVGSnwbyOZb3" async> </script> </form>
	</body>
</html>
