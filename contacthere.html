            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container">
                        ...
                        <a class="navbar-brand logo_h" href="index.html" style="color:rgb(255, 255, 255);font-size:20px;font-weight:bold;">GREEN SOCIETY</a>
                ...
                <div class="col-lg-3">
                    <div class="contact_info">
                        <div class="info_item">
                            ...
                            <h6 style="color:rgb(224, 21, 21);">Ranchi(Jharkhand)</h6>
              
                        </div><br>
                        <div class="info_item">
                            <i class="fa fa-phone"></i>
                            <h6><a href="#" style="color:blue;">9063347566</a></h6>
                     
                        </div><br>
                        <div class="info_item">
                            <i class="fa fa-envelope"></i>
                            <h6><a href="#" style="color:rgb(0, 0, 0);">support@donate.com</a></h6>
                ...
                <div class="col-lg-9">
                    <form class="row contact_form" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="col-md-12 text-right">
                            <button type="submit" value="submit" class="btn primary_btn" onclick="validation()" >Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
