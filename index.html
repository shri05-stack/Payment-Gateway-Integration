...
<body>
		...
		<div class="main_menu">
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						<a class="navbar-brand logo_h" href="index.html" style="color:white;font-size:20px;font-weight:bold;">GREEN SOCIETY</a>
	...
	<section class="home_banner_area">
		<div class="banner_inner">
			<div class="container">
				<div class="banner_content">
					<p class="upper_text">Save the World,</p>
					<h2>Save yourself</h2>
					<p>
						If you think the economy is more important than the environment, 
						try holding your breathe while counting your money.
					</p>
	   ...
	   <script src="jquery-3.2.1.min.js"></script>
		...
		<footer>
			<span>copyright&#169; Shrijan Prakash 2021</span>
		</footer>
</body>
</html>
